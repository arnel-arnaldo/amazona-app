...
// create API to dump dummy products to MongoDB
productRouter.get('/seed', expressAsyncHandler(async (req, res) => {
    ...
    if (seller){
        ...
        res.status(500).send({ message: 'No seller found; run first /api/users/seed' });
    }
}));
...
// create API to create a product review
productRouter.post('/:id/reviews', isAuth, expressAsyncHandler(async(req, res) => {
    ...
    if (product){
        ...
        // Update review numbers and ratings on screen
